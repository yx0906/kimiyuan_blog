...
PATH = 'content'
STATIC_PATHS = ['pages', 'images', 'extra', 'notebooks', 'extra/robots.txt']
...
MARKUP = ('md', 'ipynb')
PLUGINS = ['neighbors', 'pelican-ipynb.markup', 'sitemap', 'extract_toc', 'related_posts', 'render_math', 'filetime_from_git']
